(() => {
  ...
  extraCss.textContent = `
    ...
    .program-feature{display:grid;grid-template-columns:minmax(0,1.08fr) minmax(360px,.92fr);background:#070707;min-height:500px}
    .program-feature--previous{grid-template-columns:minmax(360px,.75fr) minmax(0,1.25fr);min-height:380px}.program-feature--previous .program-art{order:2}.program-feature--previous .program-copy{order:1}
    .program-art{position:relative;overflow:hidden;background:#111}.program-art img{width:100%;height:100%;object-fit:cover}.program-art::after{content:"";position:absolute;inset:0;background:linear-gradient(180deg,transparent 55%,rgba(0,0,0,.62))}
    .program-art small{position:absolute;left:22px;bottom:20px;z-index:2;color:#fff;font-size:.65rem;font-weight:900;letter-spacing:.13em;text-transform:uppercase}
    .program-copy{padding:clamp(32px,5vw,68px);display:flex;flex-direction:column;justify-content:center}.program-kicker{color:#00dffc;font-size:.67rem;font-weight:900;letter-spacing:.15em;text-transform:uppercase}
    .program-copy h2{margin:18px 0 12px;font-size:clamp(2.8rem,5.7vw,6.5rem);line-height:.83;letter-spacing:-.07em;text-transform:uppercase}.program-copy h2 span{display:block;color:transparent;-webkit-text-stroke:1px rgba(255,255,255,.85)}
    .program-role{margin:0;color:#fff;font-size:1rem;font-weight:800}.program-desc{margin:24px 0 0;color:#999;line-height:1.65;max-width:620px}.program-actions{margin-top:30px;display:flex;gap:10px;flex-wrap:wrap}
    ...
    .team-group-photo{position:relative;margin:0 0 34px;overflow:hidden;background:#080808;border:1px solid rgba(0,0,0,.18)}.team-group-photo img{display:block;width:100%;aspect-ratio:4/3;object-fit:cover;object-position:center center}
    ...
    @media(max-width:900px){.program-feature,.program-feature--previous{grid-template-columns:1fr}.program-feature--previous .program-art,.program-feature--previous .program-copy{order:initial}.program-art{min-height:360px}}
    ...
    @media(max-width:560px){.program-art{min-height:250px}.program-copy{padding:30px 22px}.team-group-photo img{aspect-ratio:4/3}}
  `;
      ...
      <div class="shell">
        ...
        <div class="program-stack">
          <article class="program-feature">
            <a class="program-art" href="${latest.href || '#'}" target="_blank" rel="noopener"><img src="${latest.image || '/assets/adl-logo-color-light.svg'}" alt="${latest.firstName || ''} ${latest.lastName || ''}" loading="eager"><small>Último programa · ver en YouTube ↗</small></a>
          ...
          <article class="program-feature program-feature--previous">
            <a class="program-art" href="${previous.href || '#'}" target="_blank" rel="noopener"><img src="${previous.image || '/assets/adl-logo-color-light.svg'}" alt="${previous.firstName || ''} ${previous.lastName || ''}" loading="lazy"><small>Programa anterior · ver en YouTube ↗</small></a>
